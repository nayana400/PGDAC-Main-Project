...
const ManagerSignUp = () => {
    ...
    return (
        <div className="card shadow" style={{ 
            ...
            margin: "0 auto",  
            backgroundImage: "linear-gradient(to right, lightgreen, lightcoral)"  }}>
        <div className="card-body shadow">
            ...
            >
                <Form className="form" 
                 style={{ 
                    background: "linear-gradient(to right, lightgreen, Lightgray)",
                    padding: "20px",
                    borderRadius: "10px",
                    ...
                    <div className="mb-3">
                        ...
                        <Field type="text" name="managerName" placeholder="Enter Your Name" className="form-control" />
                    ...
                    <div className="mb-3">
                        ...
                        <Field type="text" name="managerEmail" placeholder="Enter Your Email" className="form-control" />
                    ...
                    <div className="mb-3">
                        ...
                        <Field type="password" name="managerPassword" placeholder="Your Password" className="form-control" />
                    ...
                    <div className="mb-3">
                        ...
                        <Field type="password" name="confirmManagerPassword" placeholder="Confirm Password" className="form-control" />
                    ...
                    <div className="mb-3">
                        ...
                        <Field type="text" name="restaurantName" placeholder="Restaurant Name" className="form-control" />
                    ...
                    <div className="mb-3">
                        ...
                        <Field type="text" name="restaurantAdressText" placeholder="Restaurant Address" className="form-control" />
                    ...
                    <div className="mb-3">
                        ...
                        <Field type="number" name="restaurantPinCode" placeholder="Pin Code" className="form-control" />
